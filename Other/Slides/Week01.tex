...
\frame{
    ...
    \begin{itemize}
        ...
        \item Office hours: Friday 1500 - 1700
    \end{itemize}
...
\frame{
    \begin{center}
        \url{http://jayrobertvos.pythonanywhere.com/}
    \end{center}
}
...
\frame{
    ...
    \begin{center}
        \url{http://vknight.org/Computing_for_mathematics/}
    \end{center}
}
...
\frame{
    \frametitle{Feedback from last year}
        \begin{center}
            \includegraphics[width=.7\textwidth]{positive_2014-2015.png}
        \end{center}
}
...
\frame{
    \frametitle{Feedback from last year}
        \begin{center}
            \includegraphics[width=.7\textwidth]{negative_2014-2015.png}
        \end{center}
}
