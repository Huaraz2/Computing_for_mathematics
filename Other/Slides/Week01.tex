...
\frame{
    \begin{center}
        \url{http://thefightclub.herokuapp.com/}
    \end{center}
}
...
\frame{
    ...
    \begin{center}
        \url{http://vincent-knight.com/Computing_for_mathematics/}
    \end{center}
}
...
\frame{
    \frametitle{Feedback from last year}
        \begin{center}
            \includegraphics[width=.7\textwidth]{positive_2013-2014.png}
        \end{center}
}
...
\frame{
    \frametitle{Feedback from last year}
        \begin{center}
            \includegraphics[width=.7\textwidth]{negative_2013-2014.png}
        \end{center}
}

\frame{
    \frametitle{Helping a final year student.}
    \begin{center}
        \href{http://goo.gl/CyfWrw}{Imogen Dunne}
    \end{center}
}

\frame{
    \begin{center}
        \url{http://python-namibia.org/}
    \end{center}
}
