...
\frame{
    \begin{center}
        \includegraphics[width=\textwidth]{facial_hair.jpg}
    \end{center}
    \pause
    \begin{quote}
        ``Dafydd's facial hair is much better than Vince Knight's.''
    \end{quote}
}

\frame{
    \begin{center}
        \includegraphics[width=.8\textwidth]{negative_2014-2015.png}
    \end{center}
}

\frame{
    \begin{center}
        \includegraphics[width=.8\textwidth]{positive_2014-2015.png}
    \end{center}
}
